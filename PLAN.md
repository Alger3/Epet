...
> 首次编写：2026-07-23
> 最近更新：2026-07-25
> 当前状态：Active（0.2.0 双角色离线 Alpha 与自主移动 Gate A 原型已实现，等待 Windows 实机 DPI、多屏、命中、焦点和长稳留证；人物生成 Gate 仍待验证）
> 正式支持：Windows 11 x64
...
- 已完成阶段 2 的双角色离线纵向切片：内置橘猫、原创 Q 版成年人、角色库切换、透明 Overlay、托盘、置顶切换、自主移动原型、SQLite v5 迁移与 NSIS 构建配置。
