...
> 首次编写：2026-07-23
> 最近更新：2026-07-24
> 当前状态：Active（0.2.0 双角色离线 Alpha 已实现，等待 Windows 实机 Gate A；人物生成 Gate 仍待验证）
> 正式支持：Windows 11 x64
...
- 已完成阶段 2 的双角色离线纵向切片：内置橘猫、原创 Q 版成年人、角色库切换、透明 Overlay、托盘、SQLite v3 迁移与 NSIS 构建配置。
- 原创人物不对应任何真实人物，素材带透明通道、SHA-256、来源与再分发说明；0.2.0 不接收或上传用户照片。
- 自动验证已覆盖角色目录、权限边界、SQLite 全新安装与 v2→v3 升级、素材哈希和前端生产构建。
...
- 添加打开工坊、显示/隐藏、始终置顶、穿透、暂停、重置位置、开机启动和退出。
